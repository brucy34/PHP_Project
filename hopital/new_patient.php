          ...
          <div class="center-box" style=" height: 100px; width: 500px;text-align: center;margin-left: 420px;">
             <form action ="new_patient.php" method="POST">
              <div style="margin-top: 25px;" class="form-group">
                ...
                <input type="date" name="date_naissance" style="margin-top: 5px;" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                <input name="nom_jeune_fille_mere" style="margin-top: 5px;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter nom jeune fille mere">
              </div>
...
<!-- script php pour enregistrer chaque patient -->
<?php
  ...
  if(isset($_POST['valider']))
  {
      ...
      if(isset($_POST['id'])&&isset($_POST['nom'])&&isset($_POST['prenom'])&&isset($_POST['sexe'])&&isset($_POST['date_naissance'])&&isset($_POST['adresse'])&&isset($_POST['tel'])&&isset($_POST['nom_jeune_fille_mere']))
      {
         $reponse = Insert_patient($_POST['id'],$_POST['nom'],$_POST['prenom'],$_POST['sexe'],$_POST['date_naissance'],$_POST['adresse'],$_POST['tel'],$_POST['nom_jeune_fille_mere']);
         $name = $_POST['nom'];
         if($reponse != 1)
         {
           echo "<script> alert(\"le patient n'est pas enregistrer\")</script>";
         }
         else
         {
           echo "<script>alert(\"le patient $name a ete enregistrer avec succes\")</script>";
         }
      }
  }
